...
| The R package is immature. | NEWS, CITATION, cran-comments, pkgdown config, function index, testthat suite passed, R CMD check OK, and the archived v0.1.0 release. | Version 0.1.0 is released (tag `v0.1.0`, commit `d945dd1`; Zenodo version DOI 10.5281/zenodo.21761171); CRAN/Bioconductor submission remains pending. | Present the tagged, archived package and distinguish it from a CRAN/Bioconductor distribution. |
