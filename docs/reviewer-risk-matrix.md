...
| The R package is immature. | NEWS, CITATION, cran-comments, pkgdown config, function index, testthat suite passed, and R CMD check OK. | Release-candidate version 0.1.0; formal tag and versioned archive remain pending. | Present as reproducible research package and complete the tagged archive before submission. |
